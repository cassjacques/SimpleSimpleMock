...
<script>
    hlabel.onclick = function() {
        hlabel.style.background = "grey";
        vlabel.style.background = "rgb(79, 161, 236)";
        mlabel.style.background = "rgb(79, 161, 236)";}
    vlabel.onclick = function() {
        hlabel.style.background = "rgb(79, 161, 236)";
        vlabel.style.background = "grey";
        mlabel.style.background = "rgb(79, 161, 236)";}
    mlabel.onclick = function() {
        hlabel.style.background = "rgb(79, 161, 236)";
        vlabel.style.background = "rgb(79, 161, 236)";
        mlabel.style.background = "grey";}
